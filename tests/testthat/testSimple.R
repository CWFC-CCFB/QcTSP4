...
selectedTrees <- extractArtemisFormatFromTSP4(QcTSP4Data, plots, format="WebAPI")
...
selectedTrees <- extractArtemisFormatFromTSP4(QcTSP4Data, plotList, format="WebAPI")
...
plotList <- c(700412604, 504656201,603562101,401960602,401960601,319703404) ## only the first has trees and saplings, the others are empty plots
selectedTrees <- extractArtemisFormatFromTSP4(QcTSP4Data, plotList, format="RPackage")
test_that("Testing nb rows in selectedTrees", {expect_equal(nrow(selectedTrees), 116)})
